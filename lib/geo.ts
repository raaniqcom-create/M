...
export const TRIP_POINTS: readonly string[] = [
  ...
  'هيت', 'الوفاء', 'المحمدي', 'كبيسة', 'البغدادي', 'الحقلانية', 'بروانة', 'حديثة', 'عنة', 'راوة',
...
// والوصلات بلا اسم. و870 مساراً حُسبت مرّةً واحدة وقت البناء وخُزّنت في
 ...
 *
 *  872 ك.ب خاماً و~82 بعد ضغط الخادم — أقلّ من صورةٍ واحدة. ولا يُحمَّل على من لا
 ...
 *
 *  خمسُ محطاتٍ معتمدة لا تقابلها نقطةٌ في ملفّ الطرق أصلاً: الهيف في عنة،
