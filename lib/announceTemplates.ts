...
/** إعلاناتُ المنصّة الجاهزة — «إعلان لكلّ المستخدمين» في لوحة الإدارة.
 *
 *  تُكتب هنا مرّةً بحدود APNs/FCM (64/178) وتُعرض على صاحب المنصّة قبل الإرسال،
 *  فيرسلها من هاتفه بضغطةٍ بدل أن يعيد كتابتها في حقلين. والرابطُ يفتح ما
 *  يتكلّم عنه الإعلان لا الرئيسيةَ وحدَها. */
export const PLATFORM_NOTICES: { id: string; label: string; title: string; body: string; url: string }[] = [
  {
    id: 'dori',
    label: 'دوري — الفرديّ والزوجيّ',
    title: '🚗 الفرديّ والزوجيّ — اعرف دورك',
    body: 'أدخل رقم سيارتك مرّةً واحدة وتعرف دورك اليوم أم غداً، والمحطاتِ التي يصلها البنزين في مدينتك. والقائمةُ صارت تعرض المحطاتِ التي فيها وقودٌ الآن فقط.',
    url: '/dori',
  },
];
