...
export const ANBAR_CITIES = [
  ...
  { name: 'عانة', lat: 34.3725, lng: 41.9859 },
  { name: 'راوة', lat: 34.4833, lng: 41.9237 },
  { name: 'القائم', lat: 34.39577, lng: 40.99437 },
  { name: 'الرطبة', lat: 33.0386, lng: 40.2864 },
  { name: 'الحبانية', lat: 33.3628, lng: 43.5586 },
  { name: 'الخالدية', lat: 33.3789, lng: 43.4881 },
  { name: 'عامرية الفلوجة', lat: 33.16347, lng: 43.86422 },
  { name: 'الكرمة', lat: 33.40494, lng: 43.91423 },
  { name: 'البغدادي', lat: 33.85175, lng: 42.54918 },
  { name: 'الحقلانية', lat: 34.0575, lng: 42.3792 },
  { name: 'بروانة', lat: 34.09579, lng: 42.38882 },
  ...
  { name: 'حصيبة الشرقية', lat: 33.4207, lng: 43.4533 }, // الرمادي
  ...
  { name: 'الوفاء', lat: 33.3975, lng: 42.8531 }, // الرمادي — بلّغ عنها المالك
] as const;
