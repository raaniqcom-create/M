import { ROAD_STATIONS, type RoadStation } from './roadStations.ts';
...
// **بلا حدِّ كلمة — وكان هنا حدٌّ لا يعمل.**
//
// كُتب الرمزُ يوماً بصيغةِ حدِّ الكلمة، فتحوّل في الكتابة عبر الصدفة إلى محرف
// U+0008. فصار التعبيرُ يطلب ذلك المحرفَ قبل «محطة» — ولا نصَّ فيه محرفُ
// تحكّم. أي أنّ **إسقاطَ الضجيج لم يعمل قطّ**: «محطة تعبئة وقود الخالدية»
// كانت تُقارَن بطولها، ومطابقةُ أسماء المحطات في نموذج التسجيل أضعفُ ممّا
// كُتبت لتكون. قِيس بعد الإصلاح: «الامن» و«محطة الأمن» صارتا «الامن».
//
// ولا يُعاد الحدُّ مصحَّحاً: حدُّ الكلمة في جافاسكربت لاتينيٌّ يقوم على
// [A-Za-z0-9_]، فلا يقع بين حرفين عربيّين أصلاً.
