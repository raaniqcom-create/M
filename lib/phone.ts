...
` +
    `وإن كان جوابك الثاني فلا تحتاج حساباً أصلاً: افتح muhta.online واختر مدينتك ونوع وقودك، ` +
...
` +
    `*هل الدبّوس على المحطة نفسها؟*

` +
    `أحياناً يُضغط زرُّ الموقع والشخصُ في بيته، فيُسجَّل البيتُ بدل المحطة — والناس ` +
    `يقصدون هذا الدبّوس، فلو كان خطأً وصلوا إلى غير محطتك.

` +
    `فإن كان خطأً: افتح muhta.online، ادخل بحسابك، وصحّح الموقع من صفحة محطتك — ` +
    `أو أرسل لنا موقع المحطة عبر واتساب من داخلها.
