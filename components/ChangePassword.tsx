 ...
 *
 *  **لم يكن في المنصّة طريقٌ إليها إطلاقاً.** الطريقُ الوحيد `/reset`، وهو
 *  يمرّ برسالةٍ نصّية عبر OTPIQ — والحسابُ هناك بلا اسم مُرسِلٍ مسجَّل، فكلُّ
 *  رسالةٍ حرّة تُرفض بـ400. أي أن صاحب محطةٍ نسي كلمته لا يملك بابَ عودةٍ
 *  واحداً اليوم.
 *
 *  وهذه لا تحتاج رسالةً ولا رمزاً: من كان داخلاً بجلسته فقد أثبت أنه هو،
 *  و`auth.updateUser` تكفي. فتُغلق الثغرةُ لكلِّ مالكٍ لا لواحد.
 *
