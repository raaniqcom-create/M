        ...
        <div className="space-y-3">
          <div>
            ...
            {/* اثنتان من أوّل اثنتَي عشرة كانتا اسمَي أشخاص. واللافتةُ وحدها
                ...
                و«تُضاف تلقائياً» ليست وعداً بل وصفٌ لما يقع: المُشغّل
                stations_guard يزيدها على كلّ اسمٍ لا يحويها. وقبل ذلك كان
                النهيُ هنا يُنتج أسماءً كـ«المسرة» تصل في الإشعار فلا يُعرف
                أهي محطةٌ أم حيّ. */}
            <p className="mt-1 text-[11px] leading-relaxed text-slate-400">
              <b className="text-slate-600">لا تكتب كلمة «محطة»</b> — تُضاف تلقائياً. اكتب اسمها
              فقط كما يعرفه الناس، ولا تكتب اسمك الشخصي.
            </p>
          </div>
