    ...
    <div>
      ...
      {open && (
        <div className="panel-enter mt-2 space-y-4 rounded-2xl bg-white p-4 text-right shadow-lift">
          ...
          {/* لا عنوانَ فوق فراغ.
            *
            *  حين تُمرَّر cityCounts فارغةً — وهي كذلك داخل الورقة، لأن المدينة
            *  تُختار من شريط النطاق وحده — كانت المجموعة تبقى: عنوانٌ وشريحةٌ
            *  واحدة ميتة «كل الأنبار» لا تفعل شيئاً. ستّون بكسلاً تقول للقارئ
            *  إن ثمّة شيئاً ناقصاً، وهو ليس ناقصاً بل منقولاً إلى الأعلى. */}
          {cityCounts.size > 0 && (
          <div>
