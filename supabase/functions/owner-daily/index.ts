...
const MESSAGES: Record<string, (name: string, n: number, city: string) => Msg> = {
  ...
  no_stock: (name, _n, _city) => ({
    title: `${name} — لا وقود معلَناً على صفحتك`,
    body: 'بطاقتك تظهر مشطوبةً «لا يوجد الآن» في آخر القائمة. أعلن ما وصلك، أو ضع موعد الوصول إن عرفته — ولا تضع موعداً لا تعرفه.',
  }),
};
