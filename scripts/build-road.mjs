...
//
//  **وينتهي عند الرابعة والستّين، لأن ما بعدها لم يُسجَّل.** قِيست وتيرةُ
//  الكلام بين ما أثبته المالكُ سماعاً فكانت 12.1 حرفاً في الثانية، ثمّ
//  قِيست بها المقاطعُ الثمانية فانطبق كلُّ مقطعٍ على فقرةٍ كاملة أو فقرتين:
//  إحدى عشرةَ فقرةً لا سبعَ عشرة. والستُّ الباقية — من «ولكلِّ طريقٍ
//  امتدادُه الأطول» إلى «حمّل المحطةَ التقنية» — مكتوبةٌ ولم تُقرأ.
const PARA_SCENE = [0, 2.9, 6, 11, 18, 24, 34, 42, 51, 51, 64];
