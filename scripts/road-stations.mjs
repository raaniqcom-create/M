...
const CITIES = [
  ...
  ['حديثة', 34.1372, 42.3789], ['عانة', 34.4686, 41.9375], ['راوة', 34.4756, 41.9139],
  ['القائم', 34.3689, 41.0906], ['الرطبة', 33.0386, 40.2864], ['الحبانية', 33.3628, 43.5586],
  ['الخالدية', 33.3789, 43.4881], ['عامرية الفلوجة', 33.2264, 43.6786], ['الكرمة', 33.4453, 43.7972],
  ['البغدادي', 33.8517, 42.6472], ['الحقلانية', 34.0575, 42.3792], ['بروانة', 34.1508, 42.3739],
  ['النخيب', 32.0369, 42.2506],
  ['كبيسة', 33.5941, 42.6185], ['المحمدي', 33.5509, 42.9011], ['الصقلاوية', 33.3964, 43.6833], ['حصيبة', 33.4207, 43.4533], ['الرحالية', 32.7658, 43.3911], ['العبيدي', 34.4281, 41.2173], ['الكرابلة', 34.3909, 41.0464], ['الرمانة', 34.3931, 41.078], ['عكاشات', 33.6675, 39.967], ['الوليد', 33.4328, 38.9321],
