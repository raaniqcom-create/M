...
const ROADS = [
  ...
  { ref: '22', label: 'طريق الحج البري', note: 'الرمادي ↔ النخيب ↔ عرعر' },
  { ref: '21', label: 'طريق الرطبة — النخيب', note: '' },
  { ref: '20', label: 'طريق عكاشات', note: '' },
];

// غرب العراق وجنوبه الغربي: من الحدود الأردنية شرقاً إلى بغداد، ومن
// الحدود السعودية (عرعر عند خط عرض 30.97) شمالاً إلى القائم.
// وحدٌّ أضيق كان يقطع طريق الحج البري قبل أن يبلغ الحدود.
const BBOX = '29.50,38.50,34.80,44.60';
